...
/* ─────────────────────────────────────────────────────────
   ...
   Renders headline, subtext, two CTAs, trust badges,
   and an inline SVG laptop illustration.
   ───────────────────────────────────────────────────────── */
...
(function () {
  ...
  /* ── Big brand-coloured laptop illustration ───────────── */
  function heroIllustration() {
    return `
      <svg class="hero-art" viewBox="0 0 560 440" fill="none"
        ...
        <path d="M 60 330 L 500 330 L 540 380 L 20 380 Z"
              fill="url(#heroBase)"/>
        ...
        <!-- screen content: brand logo mark -->
      ...
      <div class="hero-grid">
        ...
        <div class="hero-copy">
          ...
          <div class="hero-ctas">
            ...
            <a href="${PHONE_TEL}" class="btn btn-outline-light btn-lg">
          ...
          <ul class="hero-trust">
            ...
            <li>
              ...
              <span>4.9 &middot; 1.2k reviews</span>
            </li>
          </ul>
